...
|/|DESCRIPTION|
|--:|:--|
|Paramères|1<sup>er</sup>`RDI` `RSI` `RDX` `RCX` `R8` `R9` : entier 64 bits<br>`XMM0` `XMM1` `XMM2` `XMM3` `XMM4` `XMM5` : flottant 128 bits (SSE)<br>`YMM0` `YMM1` `YMM2` `YMM3` `YMM4` `YMM5` : flottant 256 bits (AVX)<br>`ZMM0` `ZMM1` `ZMM2` `ZMM3` `ZMM4` `ZMM5` : flottant 512 bits (AVX-512)|
