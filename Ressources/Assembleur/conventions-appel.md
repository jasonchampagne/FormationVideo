...
|/|DESCRIPTION|
|--:|:--|
|Paramères|`RDI`, `RSI`, `RDX`, `RCX`, `R8`, `R9` (entiers)<br>`XMM0...XMM7` (flottants)|
...
|Registres conservés<br>_(callee-saved)_|`RBX`, `RBP`, `RSP`, `R12...R15`|
|Registres volatiles<br>_(caller-saved)_|`RAX`, `RCX`, `RDX`, `RDI`, `RSI`, `R8`, `R9`, `R10`, `R11`<br>`XMM0...XMM15`|
